...
Public Class SqlEXTB0104
    ...
    '2016.11.2 m.hayabuchi MOD 課題No.59
    ...
    Public Function registerYoyakuInfo(ByRef Cmd As NpgsqlCommand, _
                                   ByRef Cn As NpgsqlConnection, _
                                   ByVal dataEXTB0104 As DataEXTB0104, _
        ...
        Try
            ...
            '2016.11.4 m.hayabuchi MOD Start 課題No.59
            'Cmd.Parameters(0).Value = dataEXTB0104.PropStrCanUkeDt
            'Cmd.Parameters(1).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrCanUkeUsercd)
            'Cmd.Parameters(2).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrYoyakuSts)
            'Cmd.Parameters(3).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrShisetuKbn)
            'Cmd.Parameters(4).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrStudioKbn)
            'Cmd.Parameters(5).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrSaijiNm)
            'Cmd.Parameters(6).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrShutsuenNm)
            'Cmd.Parameters(7).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrKashiKind)
            'Cmd.Parameters(8).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoType)
            'Cmd.Parameters(9).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrDrinkFlg)
            'Cmd.Parameters(10).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrSaijiBunrui)
            'Cmd.Parameters(11).Value = commonLogicEXT.convInsNumStr(dataEXTB0104.PropStrTeiin)
            'Cmd.Parameters(12).Value = DBNull.Value
            'Cmd.Parameters(13).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoshaCd)
            'Cmd.Parameters(14).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoNm)
            'Cmd.Parameters(15).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoKana)
            'Cmd.Parameters(16).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrSekininBushoNm)
            'Cmd.Parameters(17).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrSekininNm)
            'Cmd.Parameters(18).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrSekininMail)
            'Cmd.Parameters(19).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrDaihyoNm)
            'Cmd.Parameters(20).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoTel11)
            'Cmd.Parameters(21).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoTel12)
            'Cmd.Parameters(22).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoTel13)
            'Cmd.Parameters(23).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoTel21)
            'Cmd.Parameters(24).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoTel22)
            'Cmd.Parameters(25).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoTel23)
            'Cmd.Parameters(26).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoNaisen)
            'Cmd.Parameters(27).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoFax11)
            'Cmd.Parameters(28).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoFax12)
            'Cmd.Parameters(29).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoFax13)
            'Cmd.Parameters(30).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoYubin1)
            'Cmd.Parameters(31).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoYubin2)
            'Cmd.Parameters(32).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoTodo)
            'Cmd.Parameters(33).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoShiku)
            'Cmd.Parameters(34).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoBan)
            'Cmd.Parameters(35).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoBuild)
            'Cmd.Parameters(36).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoLvl)
            'Cmd.Parameters(37).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrAiteCd)
            ...
            'Cmd.Parameters(48).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrBiko)
            'Cmd.Parameters(49).Value = CommonEXT.PropComStrUserId
            'Cmd.Parameters(50).Value = CommonEXT.PropComStrUserId
            'Cmd.Parameters(51).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrYoyakuNo)
            Cmd.Parameters(0).Value = dataEXTB0104.PropStrCanUkeDt
            Cmd.Parameters(1).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrCanUkeUsercd)
            Cmd.Parameters(2).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrYoyakuSts)
            Cmd.Parameters(3).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrShisetuKbn)
            ...
            Cmd.Parameters(22).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoTel13)
            Cmd.Parameters(23).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoTel21)
            Cmd.Parameters(24).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoNaisen)
            Cmd.Parameters(25).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoFax11)
            Cmd.Parameters(26).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoFax12)
            Cmd.Parameters(27).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoFax13)
            Cmd.Parameters(28).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoYubin1)
            Cmd.Parameters(29).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoYubin2)
            Cmd.Parameters(30).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoTodo)
            Cmd.Parameters(31).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoShiku)
            Cmd.Parameters(32).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoBan)
            Cmd.Parameters(33).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoBuild)
            Cmd.Parameters(34).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrRiyoLvl)
            Cmd.Parameters(35).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrAiteCd)
            ...
            Cmd.Parameters(44).Value = DBNull.Value
            Cmd.Parameters(45).Value = DBNull.Value
            Cmd.Parameters(46).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrBiko)
            Cmd.Parameters(47).Value = CommonEXT.PropComStrUserId
            Cmd.Parameters(48).Value = CommonEXT.PropComStrUserId
            Cmd.Parameters(49).Value = commonLogicEXT.convInsStr(dataEXTB0104.PropStrYoyakuNo)
            '2016.11.4 m.hayabuchi MOD End 課題No.59
    ...
    Public Function GetSqlSekininshaMailTelData(ByRef Adapter As NpgsqlDataAdapter, _
                                       ByRef Cn As NpgsqlConnection, _
                                       ByVal dataEXTB0104 As DataEXTB0104) As Boolean
        ...
        Try
            ...
            'バインド変数の値を設定
            With Adapter.SelectCommand
                .Parameters(":SekininNm").Value = dataEXTB0104.PropStrSekininNm   '責任者名
                .Parameters(":RiyoshaCd").Value = dataEXTB0104.PropStrRiyoshaCd   '利用者コード 
            End With
