...
''' </summary>
''' <remarks>
''' EXTCプロジェクト内で共通で使用する定数を定義する。
''' <para>作成情報：2015/09/01 h.endo</para>
''' <p>改訂情報:</p>
''' </remarks>
Module CommonDeclareEXTC
    ...
    '* 共通定数
    '***************************************************************************************
    Public Const TITLE As String = "EXTC"   'タイトル
    ...
    'オペレーションモード
    Public Const OPERATE_RIGHTMENU = "1"        '右クリックメニュー
    Public Const OPERATE_BUTTON = "2"           'ボタン

    '最大予約件数
    Public Const MAXYOKAKUCNT_RIGHTMENU = 3     '右クリックメニュー
    Public Const MAXYOKAKUCNT_BUTTON = 6        'ボタン

    '最大キャンセル件数
    Public Const MAXCANCELCNT_RIGHTMENU = 3     '右クリックメニュー
    Public Const MAXCANCELCNT_BUTTON = 6        'ボタン
    ...
    '出力メッセージ
    Public Const C0103_C0009 As String = "ファイルを出力します。よろしいですか？"

    Public Const EXTC_C0008 As String = "印刷します。よろしいですか？"
