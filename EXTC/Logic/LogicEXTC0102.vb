...
Public Class LogicEXTC0102
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function GetYoyakuData(ByRef dataEXTC0102 As DataEXTC0102) As Boolean
        'ログ出力
        ...
        Try
            ...
            If sqlEXTC0102.setSelectYoyakuData(Adapter, Cn, dataEXTC0102.PropStrYoyakuNo) = False Then
                '異常終了
                Return False
            End If
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function TransData(ByRef dataEXTC0102 As DataEXTC0102, ByVal Table As DataTable) As Boolean
        Try
            With dataEXTC0102
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function GetRiyobiData(ByRef dataEXTC0102 As DataEXTC0102) As Boolean
        'ログ出力
        CommonLogic.WriteLog(Common.LogLevel.TRACE_Lv, "START", Nothing, Nothing)
        ...
        Try
            ...
            'SELECT用SQLCommandを作成
            If sqlEXTC0102.setSelectRiyobiData(Adapter, Cn, dataEXTC0102.PropStrYoyakuNo) = False Then
                '異常終了
                Return False
            End If
            ...
            End If
            '値の設定
            TransDataRiyobiList(dataEXTC0102, Table)
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function TransDataRiyobiList(ByRef dataEXTC0102 As DataEXTC0102, ByVal Table As DataTable) As Boolean
    ...
    ''' <p>改訂情報:</p>
    ''' </para></remarks>
    Public Function RegYoyakuInfo(ByRef dataEXTC0102 As DataEXTC0102, _
        ...
        Try
            ...
            sqlEXTC0102.registerYoyakuInfo(Cmd, Cn, dataEXTC0102, blnIsUpdate)
            'Cmd.ExecuteNonQuery()
            ...
            If blnIsUpdate = False Then
                dataEXTC0102.PropStrYoyakuNo = strSeqNo
            End If
    ...
    Public Function DeleteYoyakuList(ByVal YoyakuNo As String) As Boolean
        ...
        Try
            ...
            '予約日程表削除処理
            Tsx = Cn.BeginTransaction
            sqlEXTC0102.deleteYoyakuList(Cmd, Cn, YoyakuNo)
            Cmd.ExecuteNonQuery()
    ...
    Public Function InsertYoyakuList(ByVal yoyakuNo As String, _
        ...
        Try
            ...
            For Each dataRiyobi As CommonDataRiyobi In dataList
                'ログ出力
                sqlEXTC0102.insertYoyakuList(Cmd, Cn, dataRiyobi, yoyakuNo)
                Cmd.ExecuteNonQuery()
            Next
            Tsx.Commit()
            Cn.Close()
    ...
    Public Function DeleteYoyaku(ByVal YoyakuNo As String) As Boolean
        ...
        Try
            ...
            '予約日程表削除処理
            Tsx = Cn.BeginTransaction
            sqlEXTC0102.deleteYoyaku(Cmd, Cn, YoyakuNo)
            Cmd.ExecuteNonQuery()
    ...
    Public Function ChkRiyoshaRegister(ByVal strRiyoshaKana As String) As Boolean
        ...
        Try
            ...
            'SELECT用SQLCommandを作成
            If sqlEXTC0102.setSelectRiyosha(Adapter, Cn, strRiyoshaKana) = False Then
                '異常終了
                Return False
            End If
    ...
    Public Function GetSekininshaList(ByVal strRiyoshaCd As String) As ArrayList
        ...
        Try
            ...
            'SELECT用SQLCommandを作成
            If sqlEXTC0102.setSelectSekininName(Adapter, Cn, strRiyoshaCd) = False Then
                '異常終了
                Return list
            End If
    ...
    Public Function GetSekininshaMailTel(ByVal dataEXTC0102 As DataEXTC0102) As Boolean
        ...
        Try
            ...
            'SQLの作成・設定
            If sqlEXTC0102.GetSqlSekininshaMailTelData(Adapter, Cn, dataEXTC0102) = False Then
                Return False
            End If
